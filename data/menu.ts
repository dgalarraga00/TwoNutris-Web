...
export const weeklyMenu: MenuItem[] = [
  ...
  { id: "lun-e1", name: "Ensalada de Vainitas y Zanahoria con Chochos", image: "/images/Fotos-menu/Ensalada-de-Vainitas-y-Zanahoria-con-Chochos.png", weight: 130, calories: 65, macros: { protein: 4, carbs: 8, fat: 2 }, allergens: [], ingredients: "Este plato está hecho con: Ensalada crujiente que combina bastones finos de zanahoria con vainitas cortadas al sesgo y blanqueadas. Gana frescura con plumas de cebolla perla (suavizada en agua helada) y se completa con el toque tradicional, nutritivo y lleno de textura de los chochos.\n\n*Este plato puede contener otros alérgenos ya que, por el momento, todos los platos se elaboran artesanalmente en el mismo obrador.", category: "ensalada", day: "lunes" },
  { id: "lun-e2", name: "Mix de Espinaca, Pepino y Lechuga", image: "/images/Fotos-menu/Mix-de-Espinaca-Pepino-y-lechuga.png", weight: 120, calories: 16, macros: { protein: 1, carbs: 3, fat: 0 }, allergens: [], ingredients: "Este plato está hecho con: Ensalada ligera y refrescante con una base de hojas de espinaca (baby o finamente troceadas). Aporta mucha hidratación gracias a las medias lunas de pepino (conservando su piel) y un toque sutilmente picante con láminas muy finas de rábano.\n\n*Este plato puede contener otros alérgenos ya que, por el momento, todos los platos se elaboran artesanalmente en el mismo obrador.", category: "ensalada", day: "lunes" },

  { id: "mar-e1", name: "Ensalada de Brócoli, Pimiento y Cebolla", image: "/images/Fotos-menu/Ensalada-de-Brocoli-Pimiento-y-cebolla.png", weight: 130, calories: 32, macros: { protein: 2, carbs: 6, fat: 0 }, allergens: [], ingredients: "Este plato está hecho con: Mezcla colorida y llena de textura que destaca por sus floretes pequeños de brócoli cocidos al vapor hasta quedar al dente. Contrasta maravillosamente con el dulzor de las julianas de pimiento rojo y el toque sutil de acidez de la cebolla paiteña ligeramente curtida.\n\n*Este plato puede contener otros alérgenos ya que, por el momento, todos los platos se elaboran artesanalmente en el mismo obrador.", category: "ensalada", day: "martes" },
  { id: "mar-e2", name: "Espirales de Zuquini y Tomate", image: "/images/Fotos-menu/Espirales-de-Zuquini-y-Tomate.png", weight: 130, calories: 16, macros: { protein: 1, carbs: 3, fat: 0 }, allergens: [], ingredients: "Este plato está hecho con: Ensalada divertida y ligera servida sobre una base suave de lechuga de seda. Destacan los fideos o espirales de zuquini fresco y crujiente, acompañados de la jugosidad y acidez perfecta de los cubos de tomate riñón sin semillas.\n\n*Este plato puede contener otros alérgenos ya que, por el momento, todos los platos se elaboran artesanalmente en el mismo obrador.", category: "ensalada", day: "martes" },

  { id: "mie-e1", name: "Ensalada de Col Morada, Pimiento y Zanahoria", image: "/images/Fotos-menu/Ensalada-de-Col-Morada-Pimiento-y-Zanahoria.png", weight: 130, calories: 32, macros: { protein: 1, carbs: 7, fat: 0 }, allergens: [], ingredients: "Este plato está hecho con: Ensalada vibrante y muy crujiente donde la protagonista es la col morada picada muy finamente. Se complementa a la perfección con la dulzura natural de la zanahoria rallada y el frescor de los cubitos diminutos de pimiento verde.\n\n*Este plato puede contener otros alérgenos ya que, por el momento, todos los platos se elaboran artesanalmente en el mismo obrador.", category: "ensalada", day: "miercoles" },
  { id: "mie-e2", name: "Mix de Palmito y Acelga con Tomate Cherry", image: "/images/Fotos-menu/Mix-de-Palmito-y-Acelga-con-Tomate-Cherry.png", weight: 130, calories: 24, macros: { protein: 1, carbs: 5, fat: 0 }, allergens: [], ingredients: "Este plato está hecho con: Una combinación suave y elegante con una base nutritiva de hojas jóvenes de acelga (crudas o blanqueadas rápidamente). Incorpora jugosas mitades de tomate cherry y rodajas tiernas de palmito, creando un contraste de texturas muy agradable al paladar.\n\n*Este plato puede contener otros alérgenos ya que, por el momento, todos los platos se elaboran artesanalmente en el mismo obrador.", category: "ensalada", day: "miercoles" },

  { id: "jue-e1", name: "Ensalada de Zapallo Asado y Rúcula con Arvejas", image: "/images/Fotos-menu/Ensalada-de-Zapallo-Asado-y-Rucula-con-Arvejas.png", weight: 130, calories: 55, macros: { protein: 2, carbs: 10, fat: 1 }, allergens: ["Leguminosas"], ingredients: "Este plato está hecho con: Ensalada de contrastes que mezcla el sabor intenso y ligeramente picante de la rúcula con dados de zapallo asado al horno, que aportan un dulzor profundo. Se completa con la frescura de la cebolla blanca finamente picada y el toque tierno de las arvejas cocidas.\n\n*Este plato puede contener otros alérgenos ya que, por el momento, todos los platos se elaboran artesanalmente en el mismo obrador.", category: "ensalada", day: "jueves" },
  { id: "jue-e2", name: "Ensalada de Coliflor, Pepino y Tomate Riñón", image: "/images/Fotos-menu/Ensalada-de-Coliflor-Pepino-y-Tomate-Rinon.png", weight: 130, calories: 22, macros: { protein: 1, carbs: 4, fat: 0 }, allergens: [], ingredients: "Este plato está hecho con: Opción refrescante y con muy buena estructura a base de floretes de coliflor blanqueados. Gana frescura y muchísima hidratación al mezclarse con jugosas lunas de tomate riñón y cubos de pepino sin piel.\n\n*Este plato puede contener otros alérgenos ya que, por el momento, todos los platos se elaboran artesanalmente en el mismo obrador.", category: "ensalada", day: "jueves" },

  { id: "vie-e1", name: "Ensalada de Rábano, Zanahoria y Lechuga", image: "/images/Fotos-menu/Ensalada-de-Rabano-Zanahoria-y-Lechuga.png", weight: 130, calories: 20, macros: { protein: 1, carbs: 4, fat: 0 }, allergens: [], ingredients: "Este plato está hecho con: Ensalada sencilla, voluminosa y extremadamente crujiente. Utiliza una base abundante de lechuga crespa, acompañada de bastones de zanahoria que aportan un ligero dulzor y medias lunas de rábano para un final fresco y sutilmente picante.\n\n*Este plato puede contener otros alérgenos ya que, por el momento, todos los platos se elaboran artesanalmente en el mismo obrador.", category: "ensalada", day: "viernes" },
  { id: "vie-e2", name: "Mix de Espinaca con Pimiento Amarillo", image: "/images/Fotos-menu/Mix-de-Espinaca-con-Pimiento-Amarrillo.png", weight: 130, calories: 38, macros: { protein: 1, carbs: 8, fat: 0 }, allergens: [], ingredients: "Este plato está hecho con: Ensalada con mucha identidad y textura sobre una abundante base verde de hojas de espinaca decorado con pequeños cortes cuadrados de pimientos amarillos.\n\n*Este plato puede contener otros alérgenos ya que, por el momento, todos los platos se elaboran artesanalmente en el mismo obrador.", category: "ensalada", day: "viernes" },
  ...
  },
  {
    ...
    image: "/images/Fotos-menu/Pastel-de-Yogurt.png",
    weight: 85, calories: 306,
