    ...
    <>
      ...
      <main>
          ...
          <div className="max-w-[1200px] mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <p className="text-lg leading-relaxed mb-8 font-poppins text-gray-700">
                ...
                <a
                  href="#contacto"
                  className="inline-flex items-center gap-2 px-8 py-4 rounded-full text-sm font-bold transition-all duration-200 hover:scale-[1.03] no-underline font-poppins bg-leaf text-cream shadow-[0_8px_24px_rgba(20,68,0,0.25)]"
                >
              ...
              <div className="relative flex items-center justify-center min-h-[460px]">
                <div className="absolute pointer-events-none w-4/5 h-4/5 top-[10%] left-[10%] opacity-[0.07] rounded-[40%_60%_55%_45%_/_55%_45%_60%_40%] bg-leaf" />
                <div className="relative w-full overflow-hidden rounded-[3rem] max-w-[480px] aspect-[4/5]">
                  <Image
                ...
                {/* Tag flotante */}
                <div
                  className="absolute bottom-8 -left-2 md:-left-8 flex items-center gap-3 px-5 py-3 rounded-2xl font-poppins bg-white shadow-[0_8px_28px_rgba(20,68,0,0.14)]"
                >
                  <div className="flex items-center justify-center w-9 h-9 rounded-xl bg-amber">
                    <Users size={16} className="text-leaf" />
                  </div>
                  <div>
                    <p className="text-sm font-bold leading-none text-leaf">+50 empresas</p>
        ...
        <section className="bg-white py-24">
          <div className="max-w-[1200px] mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-base mt-4 max-w-lg mx-auto font-poppins text-gray-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {STATS.map(({ number, label, icon: Icon }) => (
                <div
                  key={number}
                  className="relative flex flex-col pt-10 pb-8 px-7 rounded-3xl overflow-visible bg-cream"
                >
                  <span className="text-7xl font-black leading-none mb-4 -mt-2 font-ibrand text-leaf">
                    {number}
                  </span>
                  <div className="flex items-center justify-center w-10 h-10 rounded-xl mb-4 bg-amber">
                    <Icon size={18} strokeWidth={2} className="text-leaf" />
                  </div>
        ...
        <section className="bg-white py-16">
          <div className="max-w-[1200px] mx-auto px-6">
            <div className="relative overflow-hidden rounded-[2rem] px-10 py-14 md:px-16 md:py-16 bg-leaf">
              <div className="max-w-[680px]">
                <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-6 font-ibrand text-white">
                  Algo que tenemos muy claro: la comida que preparamos tiene impacto.
                </h2>
                <p className="text-base font-semibold mb-4 leading-relaxed font-poppins text-amber">
        ...
        >
          <div className="max-w-[560px] mx-auto px-6">
            <h2 className="text-4xl md:text-5xl text-center mb-12 font-ibrand text-leaf">
              Hablemos de tu empresa
            </h2>

            {/* Formulario */}
            <div className="rounded-3xl p-8 bg-amber shadow-[0_24px_60px_rgba(20,68,0,0.1)]">
              <h3 className="text-2xl font-bold mb-6 font-ibrand text-leaf">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                {[
                  ...
                  <div key={name} className="flex flex-col gap-1.5">
                    <label
                      htmlFor={name}
                      className="text-xs font-bold font-poppins text-leaf"
                    >
                      {label}
                    </label>
                    <input
                ...
                <button
                  type="submit"
                  className="w-full py-4 rounded-xl text-sm font-bold mt-2 cursor-pointer border-0 transition-all duration-200 hover:scale-[1.02] font-poppins bg-cream text-leaf shadow-[0_4px_16px_rgba(20,68,0,0.15)]"
                >
            ...
            {/* Horario */}
            <p className="text-xs text-center mt-6 font-poppins opacity-75 text-leaf">
